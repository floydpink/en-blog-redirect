...
get '/2009/09/husn-e-haqiqi-english-translation.html' do
  redirect "#{ROOT}/2009/09/20/husn-e-haqiqi-english-translation/", 301
end
...
get '/2009/06/why-is-it-that-i-am-not-able-to-blog.html' do
  redirect "#{ROOT}/2009/06/23/why-is-it-that-i-am-not-able-to-blog/", 301
end
...
get '/2008/06/13-year-old-addressing-un.html' do
  redirect "#{ROOT}/2008/06/07/13-year-old-addressing-un/", 301
end
...
# en.blog.harimenon.com -> www.harimenon.com/categories/english-blog/
get '/' do
  redirect "#{ROOT}/categories/english-blog/", 301
end
